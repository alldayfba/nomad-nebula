"""SQLite database for Nova Sales Discord bot — chat history, knowledge base, audit log."""
...
DB_PATH = Path(os.path.join(os.path.dirname(__file__), "../../.tmp/nova_sales.db"))
...
class BotDatabase:
    """Central database for all Nova Sales Discord bot data."""
