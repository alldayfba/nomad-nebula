...
This workspace may include work on either of my two offers. Full operating systems live in `SabboOS/`:
- `SabboOS/Agency_OS.md` — Growth operating & marketing agency
- `SabboOS/Amazon_OS.md` — Amazon FBA coaching program

Global business context (ICP, promises, differentiators, defaults) is in `~/.claude/CLAUDE.md` and loads in every session.
...
Use the right model for the task — not Opus by default:

| Task type | Model |
|---|---|
| Scraping, parsing, classification, file ops | `claude-haiku-4-5-20251001` |
| Code, orchestration, emails, ad scripts, briefings | `claude-sonnet-4-6` (default) |
| VSL scripts, GammaDoc assembly, high-stakes copy | `claude-opus-4-6` |

Full routing rules: `directives/api-cost-management-sop.md`